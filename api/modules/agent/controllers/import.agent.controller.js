      ...
      Async.mapLimit(agent.domains, 1, (domain, callbackAddDomains) => {
                ...
                if (intent.scenario) {
                  ...
                  Async.series({
                    ...
                    scenario: (cb) => {
                      ...
                      scenarioToInsert = Object.assign({
                        id: scenarioId,
                        agent: agentResult.agentName,
                        domain: domainResult.domainName,
                        intent: resultIntent.intentName
                      }, scenarioToInsert);
                    ...
                    Async.parallel([
                      ...
                      (callbackAddPostFormatToIntent) => {
                        ...
                        if (intent.postFormat) {
                          ...
                          postFormatToInsert = Object.assign({
                            id: intentId,
                            agent: agentResult.agentName,
                            domain: domainResult.domainName,
                            intent: resultIntent.intentName
        ...
        Async.parallel({
          ...
          addedSettings: (callBackAgentSettings) => {
            ...
            server.inject(formatRequest(`/agent/${agentId}/settings`, 'PUT', agent.settings)
            ,
              (res) => {
