...
class NavSideBar extends React.Component { // eslint-disable-line react/prefer-stateless-function
  ...
  render() {
    const {agents, currentAgent, loginData} = this.props;
    let agentsSelect = [];
    if (agents !== false) {
         ...
         <nav>
           {loginData.loggedIn ?
            ...
            <ul className="bottom-nav">
              <li>
                <p>This is a pre-release of Articulate and is certain to have bugs or short comings. If you have any
                  questions please <a target="_blank" href="https://github.com/samtecspg/articulate/issues/new">create
                    an issue</a> or join us on <a target="_blank"
                                                  href="https://gitter.im/samtecspg/articulate">Gitter</a>.</p>
              </li>
              <li>
